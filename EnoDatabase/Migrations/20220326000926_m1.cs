        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AttackInfo = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FlagValidityInRounds = table.Column<long>(type: "bigint", nullable: false),
                    CheckedRoundsPerRound = table.Column<int>(type: "integer", nullable: false),
                    RoundLengthInSeconds = table.Column<int>(type: "integer", nullable: false),
                    DnsSuffix = table.Column<string>(type: "text", nullable: false),
                    TeamSubnetBytesLength = table.Column<int>(type: "integer", nullable: false),
                    FlagSigningKey = table.Column<byte[]>(type: "bytea", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Quarter2 = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false),
                    Quarter3 = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false),
                    Quarter4 = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Checkers = table.Column<string[]>(type: "text[]", nullable: false),
